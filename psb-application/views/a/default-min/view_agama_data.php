...
<div class="content-layout"><div class="content-layout-row"><div class="layout-cell layout-item-0" style="width: 100%" >
   <?php echo form_open($post);
      ...
      $attrib = array('name' => 'data_nama',
                     ...
                     'maxlength' => 64);
      $this->table->add_row('<div style = "width: 150px">'.'Agama'.'</div>', form_input($attrib).'<font style="color: red;"> * </font>'.form_error('data_nama', '<br><font style="color: red">', '</font>').'<br>'.'<font style="font-style: italic; color: #C1C1C1">Contoh: Islam, Budha, dll.</font>');
      //
