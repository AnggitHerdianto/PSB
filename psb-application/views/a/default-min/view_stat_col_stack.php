   ...
   $(function () {
      $('#container').highcharts({
         ...
         yAxis: { min: 0, title: {text: 'Jumlah (<?php echo $satuan; ?>)'},
            stackLabels: { enabled: true, style: {color: (Highcharts.theme && Highcharts.theme.textColor) || 'gray'}}
         },
...
<?php echo $link;?><div id="container" style="min-width: 300px; min-height: 480px; margin: 0 auto;"></div></div></div></div>
