...
<div class="content-layout"><div class="content-layout-row"><div class="layout-cell layout-item-0" style="width: 50%;" >
         <?php // data siswa////////////////////////////////////////////////////////////////////////////////////////
            ...
            $attrib = array('name' => 'data_nama',
                              ...
                              'maxlength' => 128);
            $this->table->add_row('<div style = "width: 150px">'.'Nama Lengkap'.'</div>', form_input($attrib).'<font style="color: red;"> * </font>'.form_error('data_nama', ' <font style="color: red">', '</font>').'<br>'.'<font style="font-style: italic; color: #C1C1C1">Contoh: Siti Dewi, Novita Sari, Budi Harjono, dll.</font>');
            //
            ...
            $attrib = array('name' => 'data_sekolah_asal',
                              ...
                              'style' => 'width: 90%; max-width: 300px;',
                              'maxlength' => 128);
            $this->table->add_row('Asal Sekolah', form_input($attrib).'<font style="color: red;"> * </font>'.form_error('data_sekolah_asal', ' <font style="color: red">', '</font>').'<br>'.'<font style="font-style: italic; color: #C1C1C1">Contoh: SMP N 1 Mungkid, SMP Pancasila, dll.</font>');
            //
            $attrib = array('name' => 'data_sekolah_alamat',
                              ...
                              'style' => 'width: 90%; max-width: 300px; height: 75px;',
                              'maxlength' => 255);
            ...
            $attrib = array('name' => 'data_hp',
                              ...
                              'maxlength' => 16);
            $this->table->add_row('Nomor HP', form_input($attrib).form_error('data_hp', ' <font style="color: red">', '</font>').'<br>'.'<font style="font-style: italic; color: #C1C1C1">Contoh: +6285666777888, 085777888999, dll.</font>');
            //
            $attrib = array('name' => 'data_telepon',
                              ...
                              'style' => 'width: 90%; max-width: 150px;',
                              'maxlength' => 16);
            $this->table->add_row('Nomor Telp. Rumah', form_input($attrib).form_error('data_telepon', ' <font style="color: red">', '</font>').'<br>'.'<font style="font-style: italic; color: #C1C1C1">Contoh: +62271-888888, 0274555666, dll.</font>');
            //
            $attrib = array('name' => 'data_email',
                              ...
                              'style' => 'width: 90%; max-width: 150px;',
                              'maxlength' => 128);
            $this->table->add_row('E-Mail', form_input($attrib).form_error('data_email', ' <font style="color: red">', '</font>').'<br>'.'<font style="font-style: italic; color: #C1C1C1">Contoh: bejo@gmail.com, budi@yahoo.co.id, dll.</font>');
            //
            $radio_none = array('name' => 'data_gol_darah', 'value' => encode('none'), 'checked' => set_radio('data_gol_darah', 'none', $data_gol_darah_none));
            $radio_a = array('name' => 'data_gol_darah', 'value' => encode('a'), 'checked' => set_radio('data_gol_darah', 'a', $data_gol_darah_a));
      ...
      <div class="layout-cell layout-item-0" style="width: 50%;" >
         <?php // nilai uan////////////////////////////////////////////////////////////////////////////////////////
            ...
            $this->table->set_template($template);
            //
            foreach($test_jentest as $row){
               $attrib = array('name' => 'test_jentest['.$row['jentest_id'].']',
                                 'value' => set_value('test_jentest['.$row['jentest_id'].']', $row['test_nilai']),
                                 'class' => css_form_class(form_error('test_jentest['.$row['jentest_id'].']')),
                                 'style' => 'width: 90%; max-width: 80px;',
                                 'maxlength' => 6);
               $this->table->add_row(
                    '<div style = "width: 150px">'.$row['jentest_nama'].' ('.(int)$row['jentest_persen'].'%)</div>',
                     form_input($attrib).
                     form_error('test_jentest['.$row['jentest_id'].']', ' <font style="color: red">', '</font>')
               );
            }
            //
            $this->table->add_row('', '<font style="font-style: italic; color: #C1C1C1">Contoh: 2, 3, 10, dll.</font>');
            echo $this->table->generate();
            // pilihan jurusan////////////////////////////////////////////////////////////////////////////////////////
            ...
            for($i = 1; $i <= $pilihan_jumlah_pilihan; $i++){
               $drop_down = '<select name="pilihan_jur['.$i.']" style = "width: 90%; max-width: 150px;">';
            ...
            $this->table->add_row('', '<font style="font-style: italic; color: #C1C1C1">Jurusan yang bisa dipilih saat pendaftaran</font>');
            echo $this->table->generate();
            // data orang tua / wali////////////////////////////////////////////////////////////////////////////////////////
            ...
            $attrib = array('name' => 'ot_hp_ayah',
                              ...
                              'style' => 'width: 90%; max-width: 150px;',
                              'maxlength' => 16);
            $this->table->add_row('Nomor HP Ayah', form_input($attrib).form_error('ot_hp_ayah', ' <font style="color: red">', '</font>').'<br>'.'<font style="font-style: italic; color: #C1C1C1">Contoh: +6285666777888, 085777888999, dll.</font>');
            // ibu
            ...
            $attrib = array('name' => 'ot_hp_ibu',
                              ...
                              'style' => 'width: 90%; max-width: 150px;',
                              'maxlength' => 16);
            $this->table->add_row('Nomor HP Ibu', form_input($attrib).form_error('ot_hp_ibu', ' <font style="color: red">', '</font>').'<br>'.'<font style="font-style: italic; color: #C1C1C1">Contoh: +6285666777888, 085777888999, dll.</font>');
            //
            ...
            $attrib = array('name' => 'ot_hp_wali',
                              ...
                              'style' => 'width: 90%; max-width: 150px;;',
                              'maxlength' => 16);
            $this->table->add_row('Nomor HP Wali', form_input($attrib).form_error('ot_hp_wali', ' <font style="color: red">', '</font>').'<br>'.'<font style="font-style: italic; color: #C1C1C1">Contoh: +6285666777888, 085777888999, dll.</font>');
            //
            ...
            $this->table->set_template($template);
            //
            $radio_sdh_dicek = array('name' => 'data_status',
                              'value' => encode('sdh_dicek'),
                              'checked' => set_radio('data_status', 'sdh_dicek', $data_status_sdh_dicek));
            $radio_blm_dicek = array('name' => 'data_status',
                              'value' => encode('blm_dicek'),
                              'checked' => set_radio('data_status', 'blm_dicek', $data_status_blm_dicek));
            $this->table->add_row('<div style = "width: 150px">'.'Status Data'.'</div>', form_radio($radio_sdh_dicek).'Sudah Dicek'.form_radio($radio_blm_dicek).'Belum Dicek'.form_error('data_status', ' <font style="color: red">', '</font>'));
            echo $this->table->generate();
         ?>
</div></div></div>
...
<p><?php echo form_submit('save', $simpan, 'class = "button"'); echo anchor($back, 'Kembali', 'class = "button"');?></p>
</div></div></div><?php echo form_close();?><?php $this->load->view(view('a', 'footer'));?>