...
<div class="content-layout"><div class="content-layout-row"><div class="layout-cell layout-item-0" style="width: 100%" >
   <?php echo form_open($post);
      ...
      $attrib = array(  'name' => 'data_nama',
                        ...
                        'maxlength' => 64 );
      $this->table->add_row( '<div style = "width: 150px">'.'Nama Provinsi'.'</div>', form_input($attrib).'<font style="color: red;"> * </font>'.form_error('data_nama', '<br><font style="color: red">', '</font>').'<br>'.'<font style="font-style: italic; color: #C1C1C1">Contoh: Jakarta, Yogyakarta, dll.</font>' );
      //
      $attrib = array(  'name' => 'data_pulau',
                        'value' => set_value('data_pulau', $data_pulau),
                        'class' => css_form_class(form_error('data_pulau')),
                        'style' => 'width: 90%; max-width: 300px;',
                        'maxlength' => 64 );
      $this->table->add_row('<div style = "width: 150px">'.'Pulau'.'</div>', form_input($attrib).form_error('data_pulau', ' <font style="color: red">', '</font>').'<br>'.'<font style="font-style: italic; color: #C1C1C1">Contoh: Jawa, Sumatera, dll.</font>' );
      //
